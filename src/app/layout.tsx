...
export const metadata: Metadata = {
  title: "LockedCut | Enforce Video Revisions",
  description: "LockedCut is a video review platform that physically stops client scope creep by enforcing hard limits on revisions.",
};
